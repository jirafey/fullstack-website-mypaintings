...
function MyArtwork() {
            ...
            <>
                ...
                <div className="row">
                    {artworks.map(artwork => (
                        <div className="col-md-4 mb-4 img-container" key={artwork.id}>
                            <div className="artwork-item d-flex p-2 border rounded white shadow-sm mx-auto ">
                                <div className="artwork-image me-3 offset-1 d-flex align-items-center ">
                                    <img src={artwork.image_url || placeholderImg} alt={artwork.title || 'Dzieło'} className="img-fluid rounded"
                                         style={{ width: '120px', height: '120px', objectFit: 'cover' }}
                                         onError={(e) => { e.target.onerror = null; e.target.src = placeholderImg; }} />
                                </div>
                                <div className="artwork-details flex-column flex-grow-1 ">
                                    ...
                                    <div className="mt-auto text-end">
                                        {demoMode ? (
                                            <>
                                                ...
                                                {/*</button>*/}
                                                <button className="delete-button" onClick={() => handleDeleteDemo(artwork.id)} title="Usuń post">
    ...
    return (
         <>
            ...
            <h1 className="page-title offset-1">My artwork</h1>
