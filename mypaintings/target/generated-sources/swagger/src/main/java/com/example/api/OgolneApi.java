...
public interface OgolneApi {
    ...
    @Operation(summary = "Pobierz dane dostawy użytkownika", description = "Endpoint pozwala zalogowanemu użytkownikowi pobrać swoje dane dostawy.", tags={ "Ogolne" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Dane dostawy pobrane pomyślnie", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseOgolneDaneDostawy.class))),
        
        @ApiResponse(responseCode = "401", description = "Brak autoryzacji"),
        
        @ApiResponse(responseCode = "404", description = "Dane dostawy nie znalezione") })
    @RequestMapping(value = "/ogolne/dane-dostawy",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<ResponseOgolneDaneDostawy> ogolneDaneDostawyGet(@Parameter(in = ParameterIn.HEADER, description = "Token JWT w formacie \"Bearer {token}\"" ,required=true,schema=@Schema()) @RequestHeader(value="Authorization", required=true) String authorization) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{\r\n  \"dane_dostawy\" : {\r\n    \"street_address\" : \"Baker Street 11/2\",\r\n    \"email_address\" : \"john_smith@example.com\",\r\n    \"city\" : \"Szczecin\",\r\n    \"state_province_region\" : \"Zachodniopomorskie\",\r\n    \"phone_number\" : \"+48 123 456 789\",\r\n    \"zip_code\" : \"70-000\"\r\n  },\r\n  \"message\" : \"Dane dostawy pobrane pomyślnie.\"\r\n}", ResponseOgolneDaneDostawy.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
